...
When CPU or memory utilization exceeds the configured threshold, the service scales out by creating additional pods. When utilization decreases, it scales in by removing pods, but never below the minReplicas value.
